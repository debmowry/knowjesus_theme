...
//Avetica 2012-02-17 / Luuk Verhoeven
if(!empty($USER->id)) {
    if(!isset($SESSION->isRedirected)) {
...
if ($customtheme != 'knowjesus') { /* If responsive theme is not selected the following code is used otherwise it will skip this section and jump to the code needed for the responsive layout. */
    echo '<table id="layout-table" summary="layout"><tr>';
    ...
    foreach ($lt as $column) {
        switch ($column) {
            case 'middle':
            echo '<article class="themecolumn">'. skip_main_destination();
