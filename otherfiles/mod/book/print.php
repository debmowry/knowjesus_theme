...
if ($chapter) {
    ...
    echo '</div>';
        // uncomment the following line for English.
        // echo 'Printed from www.KnowJesus.net, a ministry of the Billy Graham Evangelistic Association. ©'. date('Y') .' BGEA.';
        // uncomment the following line for Spanish.
		echo 'Impreso de www.ConociendoaJesus.net, un ministerio de la Asociación Evangelística Billy Graham. ©'. date('Y') .' BGEA.';
    echo '</body> </html>';
	...
	echo 'Printed from www.KnowJesus.net, a ministry of the Billy Graham Evangelistic Association. ©2012 BGEA.';
    echo '</body> </html>';
}
