...
class resource_base {
    ...
    */
    ...
    /// Print the page header
            ...
            switch ($column) {
                ...
                case 'left':
                    if((blocks_have_content($pageblocks, BLOCK_POS_LEFT) || $PAGE->user_is_editing())) {
                        ...
                        $leftcol = '<section class="themecolumn sideblock left-sideblock">';
                        $leftcol .= blocks_print_group($PAGE, $pageblocks, BLOCK_POS_LEFT);
                        // print_container_end();
                        $leftcol .= '</section>';
                        // echo '</td>';
                    }
                ...
                case 'right':
                    if((blocks_have_content($pageblocks, BLOCK_POS_RIGHT) || $PAGE->user_is_editing())) {
                        ...
                        // print_container_start();
                        $rightcol = '<section class="themecolumn sideblock right-sideblock">';
                        $rightcol .= blocks_print_group($PAGE, $pageblocks, BLOCK_POS_RIGHT);
                        // print_container_end();
                        $rightcol .= '</section>';
                        // echo '</td>';
                    }
        ...
        $colarray = array($leftcol, $rightcol);
        return $colarray;
    }
